...
const Testimonials = () => {
  const testimonials = [
    {
      name: 'Dianne Russell',
      testimonial: "I used  Ready 2 Go Transportation for a doctor's appointment and was impressed with their service. The driver was courteous and attentive, and the van was clean and comfortable. I highly recommend them for anyone in need of reliable and compassionate transportation services.",
      location: 'Solon, OH'
    },
    {
      name: 'Cody Jackson',
      testimonial: 'I had a great experience with Ready 2 Go Transportation. The van was comfortable and clean, the driver was professional and accommodating, and the attention to detail was impressive. I highly recommend their services.',
      location: 'Euclid, OH'
    },
    {
      name: 'Elanor Pena',
      testimonial: 'I had a fantastic experience with Ready 2 Go Transportation when I used their services to attend a social event. The driver picked me up from my care facitlity and was friendly and engaging, the van was spacious and comfortable, and the ride was enjoyable. I would highly recommend their services to everyone.',
