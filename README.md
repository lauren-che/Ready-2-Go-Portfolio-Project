...
- Before the form can be submitted the address is validated to confirm it is within a 20 mile radius of downtown Cleveland zip code and the address is a legitate address.
